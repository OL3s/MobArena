...
- Arena contract cards now render `ArenaContractData` resources with grouped enemy icons and gold/fame reward icons. Stars use total mob-fame threat on a non-linear 1-10 scale where 1 star starts around 30 threat and 10 stars is intentionally very rare, while the fame medal shows actual net fame reward. Gross earned fame is 10% of total mob-fame threat, then 1% current-company-fame decay is subtracted so low-threat contracts become less rewarding or negative for high-fame companies.
