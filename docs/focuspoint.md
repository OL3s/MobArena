...
- Arena, Healer, and Training Hall overlays now show assigned gladiators inside the overlay as a draggable row. Dragging an assigned gladiator out of the overlay starts a normal town drag and empty-space release returns them to courtyard.
